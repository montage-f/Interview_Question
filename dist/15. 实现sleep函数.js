...
var sleep_1 = function (waite, info) { return new Promise(function (resolve) {
    setTimeout(function () {
        resolve(info);
    }, waite);
}); };
sleep_1(1000, 1).then(function (info) {
...
var asyncFun = function () { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.log('我是立即执行~');
                return [4 /*yield*/, sleep_1(1000, 22)];
            case 1:
                _a.sent();
...
asyncFun();
// 使用回调函数
var callbackAsync = function (waite, cb) {
    setTimeout(function () {
        cb();
    }, waite);
};
