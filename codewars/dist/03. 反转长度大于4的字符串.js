...
// 我的答案
var spinWords = function (sentence) {
...
// 别人的答案
var spinWords1 = function (sentence) {
...
var spinWords2 = function (sentence) { return sentence.replace(/\w{5,}/g, function (w) { return w.split('').reverse().join(''); }); };
